...
Simple example Python script running on a raspberry Pi device ( or other device with Python installed ) to generate notifications on your smartphone with Pushsafer\
...
fill in personal data in **'personal.py'** before using the Python code\
